...
namespace eTheka.App.Behaviors;
public class TextDocumentBindingBehavior : Behavior<TextEditor>
{
    private TextEditor _textEditor = null;

    public static readonly StyledProperty<string> TextProperty =
        AvaloniaProperty.Register<TextDocumentBindingBehavior, string>(nameof(Text));
